...
#define RED_RESISTOR (VIN_VOLTAGE - RED_MAX_VOLT) / 0.02
#define GREEN_RESISTOR (VIN_VOLTAGE - GREEN_MAX_VOLT) / 0.02
#define BLUE_RESISTOR (VIN_VOLTAGE - BLUE_MAX_VOLT) / 0.02